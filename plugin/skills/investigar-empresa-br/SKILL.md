...
**Antes de começar, leia a skill `nuvia-fundamentos`** (ordem de custo, lookups, e como falar sem expor termos internos da base). Faça **todo o trabalho gratuito primeiro**, gaste crédito só no fim.
...
**Fase 2 — Ponte para o global (consome crédito), só quando for cruzar.**
```
...
**Fase 3 — Lado digital (consome crédito).**
```
...
Tabela: **Nome · Papel no quadro de sócios · Cargo digital · Bucket · Confiança do match**. Mais um parágrafo de leitura: quem é o alvo nº 1, onde está o controle, e (se S.A.) o aviso de que a decisão de compra pode subir para o controlador.
